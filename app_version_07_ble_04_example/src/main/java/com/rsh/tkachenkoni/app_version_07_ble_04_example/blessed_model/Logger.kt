...
internal object Logger {
    ...
    fun v(tag: String, msg: String, vararg args: Any?) {
        triggerLogger(Log.VERBOSE, tag, msg, *args as Array<out Any>)
    }
    ...
    fun d(tag: String, msg: String, vararg args: Any?) {
        triggerLogger(Log.DEBUG, tag, msg, *args as Array<out Any>)
    }
    ...
    fun i(tag: String, msg: String, vararg args: Any?) {
        triggerLogger(Log.INFO, tag, msg, *args as Array<out Any>)
    }
    ...
    fun w(tag: String, msg: String, vararg args: Any?) {
        triggerLogger(Log.WARN, tag, msg, *args as Array<out Any>)
    }
    ...
    fun e(tag: String, msg: String, vararg args: Any?) {
        triggerLogger(Log.ERROR, tag, msg, *args as Array<out Any>)
    }
    ...
    fun wtf(tag: String, msg: String, vararg args: Any?) {
        triggerLogger(Log.ASSERT, tag, msg, *args as Array<out Any>)
    }
